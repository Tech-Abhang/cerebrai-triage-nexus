...
const HeroCerebrumAI: React.FC = () => {
  ...
  return (
    <section className="relative z-10 py-12 md:py-20 px-2 md:px-6 bg-gradient-to-br from-blue-100 via-purple-100 to-white dark:from-blue-950 dark:via-purple-950 dark:to-gray-900 overflow-hidden">
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-5 bg-clip-text text-transparent bg-gradient-to-r from-blue-800 via-fuchsia-500 to-emerald-600 dark:from-blue-300 dark:via-fuchsia-200 dark:to-emerald-300 animate-fade-in">
